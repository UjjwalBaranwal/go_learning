...
/*
Go does NOT use YYYY-MM-DD like other languages.

👉 Instead it uses a reference time:
...
func main() {
	...
	fmt.Printf("Formatted as MM/DD/YYYY hh:mm:ss : %s\n", now.Format("01/02/2006 03:04:05"))
	...
	fmt.Printf("Formatted as Kitchen: %s\n", now.Format(time.Kitchen))
	fmt.Printf("Formatted as UnixDate: %s\n", now.Format(time.UnixDate))
	...
	rfc3339Str := "2025-12-25T10:00:00+05:30"

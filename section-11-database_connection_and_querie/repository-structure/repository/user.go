...
import (
	"context"
	"database/sql"
	"example/section-11-database_connection_and_querie/repository-structure/models"
...
func (r *SQLUserRepository) CreateUser(name, email, password, avatar string) (int64, error) {
